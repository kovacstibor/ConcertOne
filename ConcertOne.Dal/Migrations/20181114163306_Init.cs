    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TicketLimits", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TicketLimits_Concerts_ConcertId",
                        column: x => x.ConcertId,
                        principalTable: "Concerts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TicketLimits_TicketCategories_TicketCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketLimits_TicketCategoryId",
                table: "TicketLimits",
